...
#field("Rodné číslo:", content: optional(data, "datum_narozeni"))
...
#field("Nástup dne:", content: format-datetime(optional(data, "tabor_od")) + if optional(data, "tabor_od").len() > 0 [ v Železných Horkách])
